    ...
    <div>
      <DropdownMenu.Root>
        <DropdownMenu.Trigger>
          <button
            className={cn(
              "w-full bg-white rounded-lg border border-gray-400 px-3 h-[52px] text-gray-700 focus:border-teal-500 transition-all outline-none appearance-none text-left relative",
