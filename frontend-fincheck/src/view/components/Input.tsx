    ...
    return (
      <div className="relative">
        <input
          ...
          name={name}
          className={cn(
            "w-full bg-white rounded-lg border border-gray-400 px-3 h-[52px] text-gray-800 pt-4 peer placeholder-shown:pt-0 focus:border-teal-500 transition-all outline-none appearance-none",
